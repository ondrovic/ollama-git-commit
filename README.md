...
```bash
# Install globally with bun
bun install -g @ondrovic/ollama-git-commit

# Or add to your project
bun add @ondrovic/ollama-git-commit
```
...
```bash
# Install globally
npm install -g @ondrovic/ollama-git-commit
# or
yarn global add @ondrovic/ollama-git-commit
# or
pnpm add -g @ondrovic/ollama-git-commit

# Or add to your project
npm install @ondrovic/ollama-git-commit
# or
yarn add @ondrovic/ollama-git-commit
# or
pnpm add @ondrovic/ollama-git-commit
```
